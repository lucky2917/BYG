...
<nav class="fixed top-0 left-0 w-full bg-black text-white flex justify-center items-center p-6">
    ...
    <section class="flex flex-col items-center justify-center py-32 pt-40 text-center">
        ...
        <div class="mt-6 space-x-4">
            <button class="bg-white text-black px-6 py-3 rounded-lg font-semibold">Start for Free</button>
            <button class="bg-gray-800 text-white px-6 py-3 rounded-lg border border-gray-600">Watch Video</button>
        </div>
    </section>
